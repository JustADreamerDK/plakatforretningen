<div class="menu p-10">
    <ul>
        ...
        <li><a href="se_sommerhus.php"><h4 class="f-black">Se alle</h4></a></li>
        <li><a href="opret_sommerhus.php"><h4 class="f-black">Opret</h4></a></li>

        <li class="bold m-t-10"><h3>Kommentarer</h3></li>
        <li><a href="se_sommerhus.php"><h4 class="f-black">Se alle</h4></a></li>
        <li><a href="opret_sommerhus.php"><h4 class="f-black">Opret</h4></a></li>

        <li class="bold m-t-10"><h3>Administratorer</h3></li>
        <li><a href="se_sommerhus.php"><h4 class="f-black">Se alle</h4></a></li>
        <li><a href="opret_sommerhus.php"><h4 class="f-black">Opret</h4></a></li>
